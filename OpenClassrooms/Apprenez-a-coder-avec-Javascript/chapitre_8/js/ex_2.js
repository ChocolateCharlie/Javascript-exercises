var Personnage = {
	initPerso: function (nom, sante, force)
	{
		...
		this.sante = sante;
		this.force = force;
		this.inventaire = {pieces : 10, cles : 1};
	},
...
{
	var description = this.nom + " a " + this.sante + " points de vie, " + this.force + " en force," + this.xp + " points d'expérience, " + this.inventaire.pieces + " pièces d'or et " + this.inventaire.cles + " clés";
	return (description);
};
...
Joueur.combattre = function (adversaire)
{
	...
	if (adversaire.sante === 0)
	{
		...
		this.inventaire.pieces += adversaire.inventaire.pieces;
